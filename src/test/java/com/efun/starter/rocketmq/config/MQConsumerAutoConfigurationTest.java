...
public class MQConsumerAutoConfigurationTest {
    ...
    public void testConsumerConfiguration() throws Exception {
        ...
        Assert.assertEquals(testConsumer.getConsumer().getConsumerGroup(), "test_consumer_group");
        Assert.assertEquals(testConsumer.getConsumer().getNamesrvAddr(), "172.16.60.217:9876");
    }
