...
import com.efun.starter.rocketmq.base.MessageExtConst;
import com.efun.starter.rocketmq.trace.common.OnsTraceConstants;
import com.efun.starter.rocketmq.trace.dispatch.impl.AsyncTraceAppender;
import com.efun.starter.rocketmq.trace.dispatch.impl.AsyncTraceDispatcher;
import com.efun.starter.rocketmq.trace.tracehook.OnsConsumeMessageHookImpl;
...
/**
 * Created by suclogger on 2018-01-09.
 * 自动装配消息消费者
 */
@Slf4j
@Configuration
